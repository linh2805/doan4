...
@endif
    ...
    @csrf
    <input type="text" name="full_name" placeholder="Họ và tên" class="input-field" required>
    <input type="tel" name="phone_number" placeholder="Số điện thoại" class="input-field" required>
    <input type="email" name="email" placeholder="Email" class="input-field" required>
    <input type="text" name="school" placeholder="Bạn học trường THPT nào?" class="input-field" required>
    <input type="text" name="residence" placeholder="Bạn đang sinh sống ở đâu?" class="input-field" required>
    <select name="major" class="input-field" required>
