    ...
    <section class="contianer" style="padding-top: 20px;">
        ...
        <div style="display: flex;">
            ...
            <div class="col-lg-6 p-0">
                <img src="{{ asset($intermediate->introductory_photo) }}" alt="Giới thiệu" class="img-fluid"
            ...
            <div class="col-lg-6 d-flex flex-column justify-content-center" style="height: 100%;">
                ...
                <ul class="list-group">
                    <li class="list-group-item">⏳ Thời gian: {{ $intermediate->time }}</li>
                    <li class="list-group-item">🎓 Bằng cấp: Cao đẳng Sư phạm Mầm non</li>
                    <li class="list-group-item">📍 Địa điểm: {{ $intermediate->location }}</li>
                </ul>
            </div>
            @endforeach
        </div>
        ...
        <div class="" style="padding-top:40px">
            <div class="mb-5 animate-section">
                <section class="p-4 bg-light rounded shadow" style="padding: 2.5rem !important;">
                    ...
                    <ul class="mb-4">
                        <li style="font-size: 20px;"><strong>Kiến thức:</strong> Cung cấp nền tảng sư phạm, tâm lý trẻ
                            em và
                            kỹ
                            năng tổ chức
                            hoạt
                            động giáo dục.</li>
                        <li style="font-size: 20px;"><strong>Kỹ năng:</strong> Thành thạo việc giảng dạy, soạn giáo án,
                            và
                            giao
                            tiếp với phụ
                            huynh.</li>
                        <li style="font-size: 20px;"><strong>Thái độ:</strong> Đề cao tinh thần trách nhiệm, yêu nghề,
                            yêu
                            trẻ.
                        </li>
                    </ul>
            ...
            <div class="p-4 bg-light rounded shadow mb-5 animate-section"
                ...
                <p style="font-size: 20px;">✔️ Tham gia vào các chương trình giáo dục mầm non tại các tổ chức phi lợi
                    nhuận.
                </p>
