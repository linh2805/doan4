        ...
        <div class="" style="padding-top:40px">
            <div class="mb-5 animate-section">
                <section class="p-4 bg-light rounded shadow" style="padding: 2.5rem !important;">
                    ...
                    <ul class="mb-4">
                        <li style="font-size: 20px;"><strong>Mục tiêu chung:</strong> Đào tạo giáo viên mầm non có
                            phẩm
                            chất
                            đạo đức, kiến thức,
                        ...
                        <li style="font-size: 20px;"><strong>Mục tiêu cụ thể:</strong>
                            <ul>
                                <li style="font-size: 20px;"><strong>Kiến thức:</strong> Nắm vững tâm lý học, giáo
                                    dục
                                    học,
                                    âm nhạc, mỹ thuật và
                                    thể chất.</li>
                                <li style="font-size: 20px;"><strong>Kỹ năng:</strong> Soạn giáo án, tổ chức hoạt
                                    động,
                                    giao
                                    tiếp với trẻ và phụ
                                    huynh.</li>
                                <li style="font-size: 20px;"><strong>Thái độ:</strong> Yêu nghề, yêu trẻ, trách
                                    nhiệm và
                                    đạo
                                    đức nghề nghiệp.
                                </li>
                    ...
                    <ul>
                        ...
                        <li style="font-size: 20px;">Sinh viên tốt nghiệp các ngành liên quan đến giáo dục muốn
                            chuyển
                            sang
                            sư phạm mầm non.</li>
                        <li style="font-size: 20px;">Những người đang làm việc trong lĩnh vực giáo dục và muốn nâng
                            cao
            ...
            <div class="p-4 bg-light rounded shadow mb-5 animate-section"
                ...
                <p style="font-size: 20px;">✔️ Tham gia vào các chương trình giáo dục mầm non tại các tổ chức phi
                    lợi
                    nhuận.
                </p>
