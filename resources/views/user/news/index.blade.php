...
<link rel="stylesheet" href="./css/intro.css" type="text/css">
    ...
    <style>
        .info-card img{
            border: 2px solid #ffb885; /* Đặt viền đậm hơn */
            border-radius: 8px;
            /* overflow: hidden; */
        ...
        .info-card h5:hover, .info-card p:hover {
            cursor: pointer;
            transform: scale(1.05);
        }
        .row {
            display: flex;
            justify-content: center; /* Căn giữa các div nhỏ */
            flex-wrap: wrap; /* Cho phép các div nhỏ xuống hàng khi không đủ chỗ */
        }
        .number-div {
            text-align: center;
            margin-top: 20px;
...
<body>
    <div class="container mt-5">
        <h2 class="text-center">Thông báo của ngành</h2>
    ...
    <nav aria-label="Page navigation">
        ...
        <h2 class="text-center">Thông báo của trường</h2>
        <div class="row">
            <div class="col-md-3">
                <div class="info-card">
                    <img src="./images/1.jfif" alt="Thông tin 1">
...
<script>
    ...
    const items = [
        { img: './images/1.jfif', title: 'Lịch Làm Việc', description: 'Lịch làm việc của Sở GD&ĐT Hà Nội (Tuần thứ 3).' },
        { img: './images/1.png', title: 'Lịch Nghỉ Tết 2024', description: 'Lịch nghỉ Tết Dương lịch năm 2024 sẽ được thông báo đến Hà Nội.' },
        { img: './images/1.png', title: 'Thông Báo', description: 'Thông báo xét duyệt ngân sách năm học 2024-2025.' },
        { img: './images/1.png', title: 'Văn Bản Chỉ Đạo', description: 'Văn bản chỉ đạo về công tác phòng chống dịch bệnh cho năm học 2023-2024.' },
        { img: './images/1.jfif', title: 'Lịch Làm Việc', description: 'Lịch làm việc của Sở GD&ĐT Hà Nội (Tuần thứ 3).' },
        { img: './images/1.jfif', title: 'Lịch Làm Việc', description: 'Lịch làm việc của Sở GD&ĐT Hà Nội (Tuần thứ 3).' },
        { img: './images/1.jfif', title: 'Lịch Làm Việc', description: 'Lịch làm việc của Sở GD&ĐT Hà Nội (Tuần thứ 3).' },
        { img: './images/1.jfif', title: 'Lịch Làm Việc', description: 'Lịch làm việc của Sở GD&ĐT Hà Nội (Tuần thứ 3).' },
