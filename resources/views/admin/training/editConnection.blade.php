<div class="container">
    ...
    <form id="editForm" onsubmit="saveConnection(event, {{ $connection->id }})" method="POST"
        ...
        <div style="display:flex; gap:10px;">
            ...
            <form>
                ...
                <button type="button" onclick="cancelEdit({{ $connection->id }})" class="btn btn-danger delete-btn">Hủy</button>
