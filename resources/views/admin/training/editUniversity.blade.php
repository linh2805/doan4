<div class="container">
    ...
    <form id="editForm" onsubmit="saveUniversity(event, {{ $university->id }})" method="POST" enctype="multipart/form-data">
        @csrf
        @method('POST')
...
<button type="button" class="btn-primary" onclick="addContent()">Thêm nội dung chương trình</button>
        ...
        <button type="button" onclick="cancelEdit({{ $university->id }})" class="btn-secondary">Hủy</button>
    </form>
</div>
