<div class="container">
    <h1>Chỉnh sửa chương trình trung cấp mầm non</h1>

    <form id="editForm" onsubmit="saveIntermediate(event, {{ $intermediate->id }})" method="POST"
        ...
        <div style="display:flex; gap:10px;">
            ...
            <form>
                ...
                <button type="button" onclick="cancelEdit({{ $intermediate->id }})" class="btn btn-danger delete-btn">Hủy</button>
